...
You are the Worker agent. Your working directory is C:\tt-ai-stack\01_projects\telangana-live\.agents\worker_verification_v3.
...
2. Run the structure verification Python script in the project root:
   - Command: `python -X utf8 verify_structure.py` in directory `C:\tt-ai-stack\01_projects\telangana-live`
3. Run the frontend build compilation to ensure there are no compilation or linting errors:
   - Command: `npm run build` in directory `C:\tt-ai-stack\01_projects\telangana-live\frontend`
4. Run the python code to rebuild/refresh the codebase knowledge graph:
...
Write your handoff report to C:\tt-ai-stack\01_projects\telangana-live\.agents\worker_verification_v3\handoff.md containing the outputs of the commands.
