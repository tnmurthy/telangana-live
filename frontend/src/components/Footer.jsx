      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 text-text-muted">
            <a href="https://x.com/TGLive_" target="_blank" rel="noopener noreferrer" className="hover:text-telangana-green transition-colors" title="Follow us on X">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.005 4.150h-1.91z"/></svg>
            </a>
            <a href="https://instagram.com/TGLive_online" target="_blank" rel="noopener noreferrer" className="hover:text-telangana-green transition-colors" title="Follow us on Instagram">
