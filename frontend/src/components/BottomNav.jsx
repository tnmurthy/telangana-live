...
export default function BottomNav() {
    ...
    const items = [
        {
            label: t('common.home'), href: localizedPath('/dashboard'), icon: (
        ...
        {
            label: t('nav.services'), href: localizedPath('/services'), icon: (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
        ...
        {
            label: t('nav.report'), href: localizedPath('/report'), icon: (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
        ...
        {
            label: t('nav.jobs'), href: localizedPath('/jobs'), icon: (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
        ...
        {
            label: t('nav.news'), href: localizedPath('/news'), icon: (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
