...
export const Icons = {
    ...
    Fire: (props) => (
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.5-7 3 10 3 15-4.5 15.5 11 1.5 11-4.125 11-4.125s-1.5 3.5-3.5 4.283z" />
        </svg>
    ),
    Power: (props) => (
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
