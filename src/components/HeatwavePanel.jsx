        ...
        <section className="animate-fade-in">
            <div className="section-header">
                <div>
                    <h2 className="section-title flex items-center gap-2">
                        <span className="text-red-400">🌡️</span> Cooling Dashboard
                    </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                ...
                <div className="glass-card p-5 border-red-500/20">
                    <p className="label-xs mb-2">🌡️ Live Temperature</p>
                ...
                <div className="glass-card p-5 border-orange-500/20">
                    <p className="label-xs mb-2">☀️ UV Index</p>
                ...
                <div className="glass-card p-5 sm:col-span-2">
                    <p className="label-xs mb-3">⚡ Quick Actions</p>
                    <div className="flex flex-wrap gap-2">
                        <button className="bg-blue-500/15 text-blue-300 px-4 py-2.5 rounded-xl text-xs font-semibold hover:bg-blue-500/25 transition-all border border-blue-500/20">
                            💧 Nearest ORS Point
                        </button>
                        <a href="tel:108" className="bg-red-500/15 text-red-300 px-4 py-2.5 rounded-xl text-xs font-semibold hover:bg-red-500/25 transition-all border border-red-500/20">
                            🚑 Heatstroke Helpline (108)
                        </a>
                        <button className="bg-green-500/15 text-green-300 px-4 py-2.5 rounded-xl text-xs font-semibold hover:bg-green-500/25 transition-all border border-green-500/20">
                            🏥 Nearest Hospital
                        </button>
                    </div>
                    {/* ORS Points */}
