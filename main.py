...
# Resolve data_engine path relative to this file so `python main.py` works
# from any working directory.
_DATA_ENGINE = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'scripts', 'data_engine.py')
...
def run_full_cycle():
    ...
    print("-" * 70)
    try:
        result = subprocess.run([sys.executable, _DATA_ENGINE], capture_output=True, text=True)
    ...
    # STEP 1: Monitor
    print("🔍 STEP 1: Analysing content for updates...")
    print("-" * 70)
